...
public class SphericalPlayerActivity extends AppCompatActivity {
    private final String SAMPLE_VIDEO_PATH =
            "android.resource://com.oculus.sample/raw/" + R.raw.sample360_2;
    ...
    private void requestExternalStoragePermission() {       //권한 설정.
    ...
    public static void toast(Context context, String msg) {     //토스트 메시지.
        Toast.makeText(
                context,
                msg,
    ...
    private void init() {
        videoPlayer.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() {    //이벤트 리스너
    ...
    @Override
    public void onRequestPermissionsResult(     //권한 설정
    ...
    public static String readRawTextFile(Context context, int resId) {      //파일 읽어옴
